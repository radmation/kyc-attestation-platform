import { IsOptional, IsString, IsUrl, Matches, MaxLength, IsIn } from 'class-validator';
...
export class UpdateBrandingDto {
  ...
  @IsOptional()
  @IsString()
  @IsIn(['Inter', 'Roboto', 'Open Sans', 'Lato', 'Poppins', 'system-ui', 'sans-serif'], {
  ...
  @IsOptional()
  @IsString()
  @Matches(/^[0-9]+(\.[0-9]+)?(px|rem|em)$/, { message: 'Border radius must be in px, rem, or em units' })
  borderRadius?: string;
