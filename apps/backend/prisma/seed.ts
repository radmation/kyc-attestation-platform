...
async function main() {
  ...
  const permissions = [
    ...
    {
      name: 'kyc:read',
      description: 'Read KYC information',
      resource: 'kyc',
      action: 'read',
    },
    ...
    },
    {
      ...
      description: 'Read attestation information',
      resource: 'attestation',
      action: 'read',
    },
    {
      name: 'attestation:approve',
      description: 'Approve attestations',
      resource: 'attestation',
      action: 'approve',
    },
    {
      name: 'attestation:revoke',
      description: 'Revoke attestations',
      resource: 'attestation',
      action: 'revoke',
    },
  ...
  const platformAdminPermissions = allPermissions.filter(
  ...
  console.log(
    '🏢 Client-scoped roles will be created dynamically when clients are added',
  );
