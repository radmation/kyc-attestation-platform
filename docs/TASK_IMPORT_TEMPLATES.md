...
iDenfy Integration Setup,Not Started,P0,M,Module 1: Identity & Attestation,1,backend;integration,Integrate with iDenfy API for KYC verification
...
iDenfy Integration Setup,Not Started,High,Backend Team,2024-03-01,2024-03-15,Module 1,8,Integrate with iDenfy API for KYC verification
